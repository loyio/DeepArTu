...
def moveImageTodir(path,targetPath,name):
    if os.path.isdir(path):
        image_name = "/content/drive/MyDrive/lanenet-lane-detection-master/data/deepartu/gt_image/"+str(name)+".png"
        binary_name = "/content/drive/MyDrive/lanenet-lane-detection-master/data/deepartu/gt_binary_image/"+str(name)+".png"
        instance_name = "/content/drive/MyDrive/lanenet-lane-detection-master/data/deepartu/gt_instance_image/"+str(name)+".png"
...
if __name__ == "__main__":
    ...
    with open("./train.txt", 'w+') as file:
        ...
        for images_dir in os.listdir("./images"):
            dir_name = os.path.join("./images", images_dir)
            if os.path.isdir(dir_name):
                train_rows = moveImageTodir(dir_name, "./", str(count).zfill(4))
