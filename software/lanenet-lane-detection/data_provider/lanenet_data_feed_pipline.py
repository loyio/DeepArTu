...
class LaneNetDataProducer(object):
    ...
    def generate_tfrecords(self):
        ...
        print("self: ", self._val_example_index_file_path)
    ...
    def _is_source_data_complete(self):
        ...
        :return:
        """
        print("exists: "+str(ops.exists(self._gt_instance_image_dir)))
        print("exists: " + str(ops.exists(self._gt_binary_image_dir)))
        print("exists: " + str(ops.exists(self._gt_image_dir)))
        return \
    ...
    def next_batch(self, batch_size):
        ...
        with tf.device('/cpu:0'):
            with tf.name_scope('input_tensor'):
                ...
                dataset = tf.compat.v1.data.TFRecordDataset(tfrecords_file_paths)
